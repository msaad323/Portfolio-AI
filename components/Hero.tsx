    ...
    <section className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-sky-500/40 bg-sky-500/10 px-3 py-1 text-[11px] font-medium text-sky-100 shadow-[0_0_30px_rgba(56,189,248,0.3)]">
              <span className="flex h-1.5 w-1.5 rounded-full bg-emerald-400" />
              Available for full-time · Remote friendly
            </div>

            <h1 className="mt-5 text-4xl font-semibold leading-tight tracking-tight md:text-5xl lg:text-[3.2rem]">
              Designing{" "}
            ...
            <div className="mt-7 flex flex-wrap gap-4">
              ...
              <a
                href="/resume.pdf"
                download
                className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-700/80 bg-slate-900/60 px-6 py-2.5 text-sm font-medium text-slate-100 backdrop-blur-sm transition hover:border-sky-400 hover:text-sky-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
              >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="pointer-events-none absolute -inset-10 rounded-[2.5rem] bg-sky-500/15 blur-3xl" />
            <div className="relative overflow-hidden rounded-3xl border border-slate-800/80 bg-gradient-to-b from-slate-900/80 via-slate-950 to-slate-950/80 p-6 shadow-[0_25px_80px_rgba(15,23,42,0.95)]">
              <div className="absolute inset-x-6 top-0 h-px bg-gradient-to-r from-sky-500/0 via-sky-500/60 to-emerald-400/0" />
              ...
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs font-medium text-slate-100/90">
                    Impact across product, performance & delivery
                  </p>
                </div>
                <span className="rounded-full border border-sky-500/50 bg-sky-500/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-sky-200">
                  Proven
                </span>
              </div>
              ...
              <div className="mt-3 grid gap-3 text-[11px] text-slate-300 sm:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
                <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-3">
                  <p className="font-semibold text-slate-100">Delivery</p>
